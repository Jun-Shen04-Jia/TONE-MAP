...
class GeminiLLM(LLMInterface):
    """
    Google Gemini API interface for Gemini models.

    Requires google-generative-ai package and API key.
    """
    ...
    def get_model_pricing(self) -> Dict[str, float]:
        ...
        pricing_map = {
            ...
            'gemini-2.5-flash': {'input': 0.5, 'output': 4.0},
