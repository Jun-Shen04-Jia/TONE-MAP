...
src_dir = os.path.dirname(current_file)  # benchmark目录
project_dir = os.path.dirname(src_dir)   # src目录
workspace_dir = os.path.dirname(project_dir)
# 将项目根目录添加到Python路径
sys.path.insert(0, workspace_dir)


from src.benchmark.modules.models import CausalGraph
from causal_dataset import PerturbationObservation
